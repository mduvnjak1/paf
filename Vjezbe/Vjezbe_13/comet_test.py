...
Halley.set_initial_conditions(np.array((800*10**9,-700*10**9,0)),np.array((-10*10**(3),15*10**(3),0)),3*10**14,10*10**3)
lista_objekata=[Sun, Mercury, Venus, Earth, Mars, Halley]
U.universe_plot_trajectory(lista_objekata,F1,10**5)
plt.show()
...
Halley.set_initial_conditions(np.array((800*10**9,-700*10**9,0)),np.array((-10*10**(3),15*10**(3),0)),3*10**14,10*10**3)
lista_objekata=[Sun, Mercury, Venus, Earth, Mars, Halley]
U.universe_animate_trajectory(lista_objekata,F1,10**5)
...
while v<=9.509*10**3:
    ...
    Earth.set_initial_conditions(np.array((149.6*10**9,0,0)),np.array((0,29.783*10**(3),0)),5.9742*10**24,6371*10**3)
    Mars.set_initial_conditions(np.array((228*10**9,0,0)),np.array((0,24.1*10**(3),0)),0.642*10**24,3389.5*10**3)
    Halley.set_initial_conditions(np.array((-400*10**9,-350*10**9,0)),np.array((v,17199.26,0)),3*10**14,10*10**3)
    lista_objekata=[Sun, Mercury, Venus, Earth, Mars, Halley]
