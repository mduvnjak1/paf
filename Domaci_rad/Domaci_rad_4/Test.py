...
p1.plot_trajectory_rk(0.01)
plt.show()
for element in p1.angle_to_hit_target(100,0,0,0.1,1,5,F1,'sfera',0.2, 100, 200, 15, 0.01, 0.1):
    p=prt.Projectile()
...
plt.show()
for element in p1.angle_to_hit_target(100,0,0,0.1,1,5,F1,'kocka',0.2, 100, 100, 10, 0.01, 0.1):
    p=prt.Projectile()
    p.set_initial_conditions(100,element,0,0,0.1,1,5,F1,'kocka',0.2)
    p.plot_trajectory(0.01)
    p.reset()
plt.plot([100,100],[90,110],'k-')
plt.show()
